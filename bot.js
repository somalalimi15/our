...
///alpha codes
//Config
let INVITE = process.env.INVITE || "https://discord.gg/NRPT3q8", //رابط دعووه سيرفرك
    GUILD = process.env.GUILD || "502191699070812194", //ايدي حق سيرفرك
    OWNER = process.env.OWNER || "368768446327947265", //ايدي حساب الاونر الي بيرسل له بوتات النشر
    TOKEN = process.env.TOKEN || "NDg3OTAzNjIwNjkyNzA1MzEw.DqvvOQ.fbWiHAaC3NF9HIM5vnwtYxFIhUQ", //التوكين المستخدم لكشف بوتات نشر يعني مثل حساب وهمي
